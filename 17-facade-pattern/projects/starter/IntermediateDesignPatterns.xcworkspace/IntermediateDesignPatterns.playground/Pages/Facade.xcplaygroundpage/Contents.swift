...
//遵循hashable协议，使得Customer可以直接用做字典的key
...
let vickiPoodle = Product(identifier: "product-002", name: "Vicki's prized poodle", cost: 100)
...
//4
let customer = Customer(identifier: "customer-001", address: "1600 Pensylvania Ave, Washinng, DC 20006", name: "Johnny Appleseed")
